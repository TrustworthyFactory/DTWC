 ...
 * Source Class: DefaultCertifiedEvidence <br>
 * @version generated on Wed Oct 08 11:02:03 CEST 2014 by t0013577
 */
public class DefaultCertifiedEvidence extends WrappedIndividualImpl implements CertifiedEvidence {

    public DefaultCertifiedEvidence(OWLOntology ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends WrappedIndividual> getHasMetric() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HASMETRIC,
                                               WrappedIndividualImpl.class);
    }

    public boolean hasHasMetric() {
	   return !getHasMetric().isEmpty();
    }

    public void addHasMetric(WrappedIndividual newHasMetric) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HASMETRIC,
                                       newHasMetric);
    }

    public void removeHasMetric(WrappedIndividual oldHasMetric) {
